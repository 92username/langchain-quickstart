#!/usr/bin/env python3
# filepath: /home/nbx/Documents/Projects/langchain-quickstart/index_docs.py
...
def index_markdown_files():
    ...
    if not os.getenv("OPENAI_API_KEY"):
        raise ValueError("OPENAI_API_KEY environment variable not found. Make sure it's set in your .env file.")
